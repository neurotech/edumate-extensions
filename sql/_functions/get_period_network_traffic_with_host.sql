CREATE OR REPLACE FUNCTION DB2INST1.get_period_network_traffic_with_host (contactUsername VARCHAR(50), startDate DATE, endDate DATE)
...
RETURN
  ...
  GROUP BY username, host, start_date, start_time, end_date, end_time
