...
WITH STUDENT_ATTENDANCE_DATA AS (
  ...
  WHERE FORM_RUN = '2013 Year 11' AND (ATTENDANCE_STATUS_DAILY.DAILY_ATTENDANCE_STATUS IS NOT NULL OR ATTENDANCE_STATUS_AM.DAILY_ATTENDANCE_STATUS IS NOT NULL)
