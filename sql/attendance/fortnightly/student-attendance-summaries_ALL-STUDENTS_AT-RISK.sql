...
final_report AS (
  SELECT
    (CASE WHEN house.house LIKE '%Connor' THEN 'OConnor' ELSE house.house END) AS "GROUPING",
...
WHERE cumul_absences_average >= 1.00

ORDER BY grouping ASC, absences_ytd DESC, surname ASC, firstname ASC