...
RIGHT JOIN CONTACT ON CONTACT.CONTACT_ID = STUDENT.CONTACT_ID
RIGHT JOIN TABLE(EDUMATE.GET_ENROLED_STUDENTS_FORM_RUN(CURRENT DATE)) GSFR ON GSFR.STUDENT_ID = STUDENT.STUDENT_ID
RIGHT JOIN FORM_RUN ON FORM_RUN.FORM_RUN_ID = GSFR.FORM_RUN_ID
...
FULL JOIN ABSENCES_LATES_COUNTS ALC ON ALC.STUDENT_ID = STUDENT.STUDENT_ID
