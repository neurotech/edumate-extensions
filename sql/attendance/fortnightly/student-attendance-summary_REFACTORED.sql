...
ABSENCES_COUNTS AS (
  ...
  GROUP BY SAD.ABSENCES_STUDENT_ID, SAD.ABSENCES_SURNAME, SAD.ABSENCES_FIRSTNAME, SAD.ABSENCES_FORM_RUN, SAD.ABSENCES_FORM_RUN
),
...
LATES_COUNTS AS (
  ...
  GROUP BY SLD.LATES_STUDENT_ID, SLD.LATES_SURNAME, SLD.LATES_FIRSTNAME, SLD.LATES_FORM_RUN
)
...
INNER JOIN LATES_COUNTS LC ON LC.LATES_STUDENT_ID = AC.ABSENCES_STUDENT_ID