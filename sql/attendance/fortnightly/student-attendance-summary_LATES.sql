...
LATES_COUNTS AS (
  SELECT
    ...
    SUM(CASE WHEN SAD.LATES_DATE_ON BETWEEN SAD.REPORT_START AND SAD.REPORT_END AND SAD.ALL_LATES IS NOT NULL THEN 1 ELSE 0 END) AS "REPORT_LATES",
...
ORDER BY SAD.LATES_FORM_RUN, LC.REPORT_LATES DESC, SAD.LATES_HOMEROOM, SAD.LATES_SURNAME