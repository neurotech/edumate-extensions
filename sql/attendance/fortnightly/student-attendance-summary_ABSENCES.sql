...
ABSENCES_COUNTS AS (
  SELECT
    ...
    SUM(CASE WHEN SAD.ABSENCES_DATE_ON BETWEEN SAD.REPORT_START AND SAD.REPORT_END AND SAD.ALL_ABSENCES IS NOT NULL THEN 1 ELSE 0 END) AS "REPORT_ABSENCES",
...
ORDER BY SAD.ABSENCES_FORM_RUN, AC.REPORT_ABSENCES DESC, SAD.ABSENCES_HOMEROOM, SAD.ABSENCES_SURNAME