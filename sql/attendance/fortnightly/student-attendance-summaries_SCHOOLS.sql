WITH REPORT_VARS AS (
  SELECT
    ...
    '[[School=query_list(SELECT school FROM school ORDER BY school)]]' AS "REPORT_SCOPE"
...
WHERE school = (SELECT report_scope FROM report_vars)

ORDER BY grouping ASC, absences_ytd DESC, year_group ASC, surname ASC, firstname ASC