-- Year 11 Attendance Stats
-- 31st January 2013 to 13th May 2013
...
WITH STUDENT_ATTENDANCE_DATA AS (
  ...
  WHERE FORM_RUN = '2013 Year 10' AND (ATTENDANCE_STATUS_DAILY.DAILY_ATTENDANCE_STATUS IS NOT NULL OR ATTENDANCE_STATUS_AM.DAILY_ATTENDANCE_STATUS IS NOT NULL)
...
SELECT DISTINCT
  ...
  (CASE WHEN ALC.ROWNUMBER = 1 THEN '1st January 2013' ELSE NULL END) AS "REPORT_PERIOD_START",
