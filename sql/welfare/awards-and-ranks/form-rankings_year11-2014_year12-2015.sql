WITH report_vars AS (
  SELECT
    '2014 Year 11 Ranking' AS PREVIOUS,
    '2015 Year 12 Ranking' AS CURRENT
...
previous_course_units(unit_number) AS
    ...
    SELECT
        ...
        (CASE WHEN previous_course_rankings.department_id IN (2, 25) THEN 'C' ELSE 'E' END) AS "CORE_OR_ELECTIVE",
