WITH selected_period AS
    ...
    SELECT
        ...
        --course.course,
         (CASE
          -- Languages
          WHEN course.course IN ('07 French', '07 Italian', '07 Mandarin') THEN '07 Languages'
          ELSE course.course
        END) AS "COURSE",
    ...
    lang_avg AS (
      SELECT
        student_id,
        CASE WHEN course IN ('07 French', '07 Italian', '07 Mandarin') THEN '07 Languages' ELSE null END AS "LANG_COURSE",
        AVG(final_mark) AS "FINAL_MARK_AVG"
      FROM raw_course_results
      WHERE course IN ('07 French', '07 Italian', '07 Mandarin') AND final_mark IS NOT null
