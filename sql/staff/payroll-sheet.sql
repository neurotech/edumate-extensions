WITH REPORT_VARS AS (
  SELECT
    ...
    (DATE('[[Report From Date=date]]')) AS "REPORT_START",
    (DATE('[[Report To Date=date]]')) AS "REPORT_END"
...
SELECT
  ...
  TO_CHAR((SAD.EFFECTIVE_START), 'DD Month, YYYY') AS "EFFECTIVE_START",
  TO_CHAR((SAD.EFFECTIVE_END), 'DD Month, YYYY') AS "EFFECTIVE_END",
  SAD.DAYS_ABSENT AS "DAYS_ABSENT_PAY_PERIOD",
  YTD_SUM.DAYS_ABSENT_THIS_YEAR,
  TO_CHAR((REPORT_VARS.REPORT_START), 'DD Month, YYYY') AS "REPORT_BEGIN",
  TO_CHAR((REPORT_VARS.REPORT_END), 'DD Month, YYYY') AS "REPORT_END",
  TO_CHAR((CURRENT DATE), 'YYYY') AS "CURRENT_YEAR"
