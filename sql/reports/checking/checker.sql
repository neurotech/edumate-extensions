...
SELECT DISTINCT
  ...
  (CASE WHEN LENGTH(OUTLINES.COURSE_OUTLINE) > 200 THEN '3' ELSE '5' END) AS "LARGE_OUTLINES",
...
GROUP BY RAW.REPORT_PERIOD, RAW.STATUS, OUTCOMES.DEPARTMENT, OUTCOMES.SUBJECT, COURSE.COURSE, CLASS.CLASS, COMMENTS.COMMENT_LENGTH, OUTLINES.COURSE_OUTLINE, OUTCOMES.SEMESTER_ONE_TOTAL, OUTCOMES.SEMESTER_TWO_TOTAL, OUTCOMES.TOTAL, OUTCOMES.OUTCOME_FLAG, OUTCOMES.OUTCOME_LENGTH
)

SELECT * FROM ALL_THAT

ORDER BY DEPARTMENT, SUBJECT, COURSE, CLASS