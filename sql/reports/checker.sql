...
outcome_dataset as (
  SELECT
    ...
    LISTAGG(OUTCOME_FLAG, ' - ') WITHIN GROUP(ORDER BY OUTCOME_FLAG) "OUTCOME_FLAG",
    SEMESTER_ONE_TOTAL,
    SEMESTER_TWO_TOTAL,
    TOTAL
...
GROUP BY RAW.REPORT_PERIOD, RAW.STATUS, OUTCOMES.DEPARTMENT, OUTCOMES.SUBJECT, COURSE.COURSE, CLASS.CLASS, COMMENTS.COMMENT_LENGTH, OUTLINES.COURSE_OUTLINE, OUTCOMES.OUTCOME_FLAG, OUTCOMES.OUTCOME_LENGTH
)
